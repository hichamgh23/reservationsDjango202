...
# Dossier où Django va chercher les fichiers statiques à la racine du projet
STATICFILES_DIRS = [
    BASE_DIR / "static",
]

# Dossier utilisé lors du déploiement (collectstatic)
STATIC_ROOT = BASE_DIR / 'staticfiles'

# Gestion des médias (images des spectacles)
MEDIA_URL = 'media/'
